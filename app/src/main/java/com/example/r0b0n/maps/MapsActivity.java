...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v){
        ...
        switch(v.getId())
        {
            ...
            case R.id.B_Comic:
                ...
                String url = getUrl(latitude, longitude, comic);
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;

                getNearbyData.execute(dataTransfer);
                Toast.makeText(MapsActivity.this , "Showing nearby Book Shops", Toast.LENGTH_LONG).show();
                break;

            case R.id.B_resturant:
                mMap.clear();
                String resturant = "cafe";
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace){
        ...
        googlePlaceUrl.append("&key="+"AIzaSyCQR0ZqMesEXSGnc9WYOBGr7_nnuMcqxsg");
